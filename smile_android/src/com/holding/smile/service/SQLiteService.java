...
public class SQLiteService {
	...
	public SUser getScurrentUser() {
		SUser user = null;
		Cursor cursor = db.query("user", new String[] { "cuid", "username", "token", "mobilephone", "identitycard",
				"qq", "email", "weibo", "weixin" }, "flag = ?",
	...
	private SUser getUserById(int cuid) {
		...
		Cursor cursor = db.query("user", new String[] { "cuid", "username", "token", "mobilephone", "identitycard",
				"qq", "email", "weibo", "weixin", "flag" }, "cuid = ?",
	...
	public SUser getUserByUsername(String username) {
		SUser user = new SUser();
		Cursor cursor = db.query("user", new String[] { "cuid", "username", "token", "mobilephone", "identitycard",
				"qq", "email", "weibo", "weixin", "flag" }, "username = ?",
