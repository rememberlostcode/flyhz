...
public class GoodsDetailActivity extends BaseActivity implements OnClickListener {
	...
	private List<JDiscount>	discountList	= new ArrayList<JDiscount>();	// 相同款号的商品颜色列表
	...
	private void loadDiscounts() {
		...
		for (int i = 5; i < 10; i++) {
			JDiscount jDiscount = new JDiscount();
			jDiscount.setId(i);
			jDiscount.setDiscount(i);
			discountList.add(jDiscount);
		}
